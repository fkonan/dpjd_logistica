...
<div class="card border-success">
  ...
  <div class="card-body pt-2">
    <a href="<?=PROOT?>discapacidad/nuevo" class="btn btn-info btn-xs float-right mb-2">Nuevo registro</a>
      ...
      <table class="table table-striped table-condensed table-bordered table-hover">
        ...
        <tbody class="small">
          <?php foreach($this->datos as $datos): ?>
            <tr>
              <td><?= $datos->discapacidad; ?></a></td>
              <td>
                <a href="<?=PROOT?>discapacidad/editar/<?=$datos->id?>" class="btn btn-info btn-xs btn-sm">
                   Editar
                </a>
                <a href="<?=PROOT?>discapacidad/eliminar/<?=$datos->id?>" class="btn btn-danger btn-xs btn-sm" onclick="if(!confirm('Desea eliminar este registro?')){return false;}">
                   Eliminar
                </a>
              </td>
            </tr>
